...
public interface UserService {
    ...
    List<GetUserResponse> finByFirstNameOrLastName(String firstName, String lastName);
    List<GetUserResponse> findByEmailAndPassword(String userName, String password);
