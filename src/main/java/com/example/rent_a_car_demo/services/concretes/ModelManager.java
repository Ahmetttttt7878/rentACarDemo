...
public class ModelManager implements ModelService {
    ...
    public GetModelResponse getModelResponse(int id)  {
        GetModelResponse response = new GetModelResponse();
        Model model1 = modelRepository.findById(id).orElseThrow();
    ...
    public String deleteByModel(int id){
            this.modelRepository.findById(id).orElseThrow();
